...
namespace Notes
{
	partial class EditUser_Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.textBoxDescription = new Notes.TextBoxWithPlaceholder();
			this.textBoxLogin = new Notes.TextBoxWithPlaceholder();
			...
			this.pictureBoxUserAvatar.Image = global::Notes.Properties.Resources.NoImage;
